        ...
        systemd.services.agl-home-django = {
            ...
            serviceConfig = {
              ...
              Environment = [
                ...
                "KEYCLOAK_CLIENT_PATH=${toString config.sops.secrets."services/agl-home-django/keycloak-client-id".path}"
                "KEYCLOAK_SECRET_PATH=${toString config.sops.secrets."services/agl-home-django/keycloak-secret".path}"
              ];
            };     
